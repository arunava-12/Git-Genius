...
export default function AIChat() {
  ...
  return (
    <ProtectedRoute>
      <div
  className="flex min-h-screen flex-col text-foreground transition-colors duration-300"
  style={{
    backgroundImage:
          ...
          >
            {showWelcome ? (
              <div className="container max-w-full mx-auto px-4 md:px-8">
                <div className="text-center mb-10">
                  <div className="flex items-center justify-center gap-6 mb-8">
                    ...
                    <div className="text-left">
                      <h1 className="text-4xl font-bold text-foreground pt-8">
                        Git Genius <span className="text-primary">AI Assistant</span>
                      </h1>
                  ...
                  <div className="max-w-2xl mx-auto bg-background/40 rounded-xl p-6 backdrop-blur-md shadow-md">
                ...
                <div className="max-w-3xl mx-auto mt-12 pb-10">
                      ...
                      >
                        <div className="flex items-center mb-1 text-xs text-muted-foreground">
                          {message.role === "user" ? (
                            ...
                            <>
                              <span className="font-medium mr-1">Git Genius</span> •{" "}
                              {formatMessageTime(message.timestamp)}
                            </>
                          )}
                        </div>
                  ...
                  {isLoading && (
                    ...
                    >
                      <div className="max-w-[85%] md:max-w-[75%] flex flex-col items-start">
                        <div className="flex items-center mb-1 text-xs text-muted-foreground">
                          <span className="font-medium mr-1">Git Genius</span> • {formatMessageTime(new Date())}
                        </div>
